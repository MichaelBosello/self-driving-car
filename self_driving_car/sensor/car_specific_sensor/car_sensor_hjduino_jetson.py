...
class CarSensorHJduino():
  def __init__(self):
    self.sonar_echo = 21
    self.sonar_trigger = 20
    self.lx_distance_sensor_front = 7
    self.rx_distance_sensor_front = 8
    self.lx_distance_sensor_back = 16
    self.rx_distance_sensor_back = 6
    self.lx_line_sensor = 5
    self.rx_line_sensor = 12

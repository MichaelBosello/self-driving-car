...
class CarSensorHJduino():
  def __init__(self):
    self.front_distance_sensor = DistanceSensor(21, 20)
    self.lx_distance_sensor_front = DigitalInputDevice(7)
    self.rx_distance_sensor_front = DigitalInputDevice(8)
    self.lx_distance_sensor_back = DigitalInputDevice(5)
    self.rx_distance_sensor_back = DigitalInputDevice(6)
    self.lx_line_sensor = DigitalInputDevice(16)
    self.rx_line_sensor = DigitalInputDevice(12)
